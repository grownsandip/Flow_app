import { GetWorkflowExecutions } from "@/actions/workflows/getExecutionWorkflows";
...
export default function ExecutionPage({params}:{params:{workflowId:string}}){
    ...
    <div className="h-full w-full overflow-auto">
        ...
        <Suspense fallback={
            <div className="w-full h-full flex items-center justify-center"><Loader2Icon size={30} className="animate-spin stroke-primary"/></div>
        }>
